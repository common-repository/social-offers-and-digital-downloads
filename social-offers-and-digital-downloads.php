<?php
/*
Plugin Name: Social Offers
Plugin URI: http://www.socialintents.com
Description: Social Offers to build your email list.
Version: 1.4.53
...
add_action('admin_footer', 'sisoRedirect');
...
<?php screen_icon() ?><h2><?php _e('Social Offers by Social Intents', $siso_domain) ?></h2>
    <div class="metabox-holder meta-box-sortables ui-sortable pointer">
		...
		<p>
		<a href='#' id='dashboardLink' class="button button-primary" target="_ss">Dashboard</a>
		<a href='#' id='customizeLink' class="button button-primary" target="_ss">Customize my offer</a>
		<a href='#' id='socialLink' class="button button-primary" target="_ss">Set up my social networks</a>
...
sessionStorage.setItem("siso_pid",json.pid);
		...
		alert("Thanks for registering!  Next up:  Use the buttons under your Social Offers Plugin Settings to customize your offer.");
		$( "#saveSettings" ).submit();
	}
	else {
		alert(json.msg);
